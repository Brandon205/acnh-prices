...
export default function YourList() {
    ...
    if (localStorage.getItem('animals') === null || localStorage.getItem('animals').length === 0) { // If there are favorited animals then it should loop through them
        content = (<div className="no-animals"><h1>You haven't added any animals to your list!</h1><p>To do that all you need to do is hit the + sign on the animals info panel.</p></div>)
